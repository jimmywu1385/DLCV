...
class image_caption(nn.Module):
    def __init__(self, model_name, test=False, voc_size=18022, d_model = 768, nhead = 8, num_decoder_layers = 6, dim_feedforward = 2048, 
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_mask = None, memory_mask = None, tgt_key_padding_mask = None, memory_key_padding_mask = None):
        ...
        if self.norm_first:
            ...
            mha, attn = self._mha_block(self.norm2(x), memory, memory_mask, memory_key_padding_mask)
            x = x + mha
