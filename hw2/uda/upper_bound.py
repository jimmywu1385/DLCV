...
def main(args):
    ...
    if args.target == "svhn":
        src_datas = uda_data(os.path.join(svhn_root, "data"), os.path.join(svhn_root, "train.csv"), transform)
        ...
        src_datas = uda_data(os.path.join(usps_root, "data"), os.path.join(usps_root, "train.csv"), transform)
    ...
    for epoch in epoch_pbar:
        ...
        for i, (src_label, src_data) in enumerate(src_loader):          
            ...
            src_class, src_domain = model(src_data, alpha=0)
