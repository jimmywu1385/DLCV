...
def render_viewpoints(model, render_poses, HW, Ks, ndc, render_kwargs,
                      ...
                      eval_ssim=False, eval_lpips_alex=False, eval_lpips_vgg=False, file_name=None):
    ...
    if savedir is not None and dump_images:
        for i in trange(len(rgbs)):
            ...
            filename = os.path.join(savedir, file_name[i])
...
def load_everything(args, cfg):
    ...
    kept_keys = {
            ...
            'poses', 'render_poses', 'images', 'file_name'}
...
if __name__=='__main__':
    ...
    # load images / poses / camera settings / data split
    if args.infer:
        cfg.data.dataset_type = 'blender_infer'
        cfg.data.datadir = args.json_path
    ...
    if args.render_test or args.render_train or args.render_video or args.infer:
        if args.ft_path:
