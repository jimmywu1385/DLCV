...
from .load_blender import load_blender_data, load_blender_infer_data
...
def load_data(args):
    ...
    if args.dataset_type == 'llff':
    ...
    elif args.dataset_type == 'blender_infer':
        poses, render_poses, hwf, i_split, file_name = load_blender_infer_data(args.datadir, args.half_res, args.testskip)
        ...
        H, W = int(H), int(W)
        hwf = [H, W, focal]
        HW = np.array([[800, 800] for im in file_name])
